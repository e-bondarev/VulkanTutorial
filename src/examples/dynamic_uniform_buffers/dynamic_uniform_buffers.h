...
namespace Examples
{
	class DynamicUniformBuffers : public IExample
	{
	public:
		DynamicUniformBuffers();
		void Render() override;
		~DynamicUniformBuffers() override;
	...
	private:
		...
		DynamicUniformBuffers(const DynamicUniformBuffers&) = delete;
		DynamicUniformBuffers& operator=(const DynamicUniformBuffers&) = delete;
	};
}